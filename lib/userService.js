...
export async function findUserBySupabaseId(supabaseId) {
  // NOTE:
  // Do NOT swallow Prisma/DB errors here.
  // Returning null on errors makes the API incorrectly respond 404 (User not found),
  // which then triggers incorrect flows (e.g., creating users) and causes blank screens.
